      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Status</a></p>
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">GitHub</a> <span className="inline text-primary dark:text-blue-500">— New</span></p>
          </div>
        ...
        <div className="sm:flex sm:justify-between sm:items-center">
          ...
          <div className="flex justify-between items-center">
            <div className="mt-3 sm:hidden">
              <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">Griffin</a>
              <p className="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© 2022 Neat Digital.</p>
            </div>
