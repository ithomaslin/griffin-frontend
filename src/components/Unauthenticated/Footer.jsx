    ...
    <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div className="col-span-full hidden lg:col-span-1 lg:block">
          ...
          <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© 2022 Neat.</p>
        </div>
        {/* <!-- End Col --> */}
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Careers</a> <span className="inline text-primary dark:text-blue-500">— We're not hiring</span></p>
