    ...
    <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div className="col-span-full hidden lg:col-span-1 lg:block">
          ...
          <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© {year} TradingLab.</p>
        </div>
        {/* <!-- End Col --> */}
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="https://gryfinn.medium.com/" target='_blank'>Blog</a></p>
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Careers</a> <span className="inline text-primary dark:text-blue-500">— We're not hiring :P</span></p>
        ...
        <div className="sm:flex sm:justify-between sm:items-center">
          <div className="flex items-center gap-x-3">
            <div className="space-x-4 text-sm ml-4">
              <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="/terms">Terms</a>
              <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="/privacy">Privacy</a>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            <div className="mt-3 sm:hidden">
              <a className="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">TradingLab</a>
              <p className="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© {year} TradingLab.</p>
            </div>
            ...
            <div className="space-x-4">
              ...
              <a className="inline-block text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" href="https://github.com/Neat-Inc">
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
